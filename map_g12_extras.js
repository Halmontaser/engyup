...
const vocabSource1 = 'E:\\Books\\english_images\\english\\vocabulary_images\\grade_12';
const vocabSource2 = 'E:\\Books\\english_images\\english\\Grade 12\\\\images\\\\grade 12 visual vocab';
...
// 2. Process Flashcards g12
const flashcards = db.prepare(`SELECT id, data FROM activities WHERE type='flashcard' AND id LIKE 'g12%'`).all();
