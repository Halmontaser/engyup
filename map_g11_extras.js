...
const vocabSource1 = 'E:\\Books\\english_images\\english\\vocabulary_images\\grade_11';
const vocabSource2 = 'E:\\Books\\english_images\\english\\Grade 11\\images';
...
// 2. Process Flashcards g11
const flashcards = db.prepare(`SELECT id, data FROM activities WHERE type='flashcard' AND id LIKE 'g11%'`).all();
